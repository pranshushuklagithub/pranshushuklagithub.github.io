...
export default function Navbar({comp,setComp}){
    ...
    return <Box id="nav-menu" bg="MenuText" p="1%" boxShadow="rgba(0, 0, 0, 0.05) 0px 6px 24px 0px, rgba(0, 0, 0, 0.08) 0px 0px 0px 1px" w="100%"  position="fixed">
        ...
        <Button onClick={downloadResume}className="nav-link resume" w ={["40px","60px","80px"]} h={["20px","30px","40px"]} bg="blue.400" color="white" _hover={{bg:"green.300",color:"black"}} fontSize={["7px","10px","17px"]}  id="resume-button-1"><Link id="resume-link-1" href="https://drive.google.com/file/d/1kNSn3WLdCenTcHoQ7-o_fYYZT66umVnp/view?usp=sharing" isExternal ></Link>Resume</Button>
        </Flex>
    </Flex>
    </Box>
}