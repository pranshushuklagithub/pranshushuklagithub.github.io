...
export default function Home() {
    return <Box  id="home" h="100%" p="6%">
        ...
        <Link to="https://drive.google.com/file/d/1kNSn3WLdCenTcHoQ7-o_fYYZT66umVnp/view?usp=sharing" id="resume-link-2"><Box as="Button" border="2px" overflow="hidden" mt="2%" className="nav-link resume" w ={["40px","60px","100px"]} h={["20px","30px","50px"]} bg="green.400" color="white" _hover={{bg:"green.300",color:"black"}}fontSize={["7px","10px","17px"]} borderRadius="xl" onClick={downloadResume} id="resume-button-2">Resume</Box></Link>
        </Box>
