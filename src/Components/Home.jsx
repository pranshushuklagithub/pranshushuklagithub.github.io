...
export default function Home() {
    return <Box  id="home" h="100%" p="6%">
        ...
        <Box as="Button" border="2px" overflow="hidden" mt="2%" className="nav-link resume" w ={["40px","60px","100px"]} h={["20px","30px","50px"]} bg="green.400" color="white" _hover={{bg:"green.300",color:"black"}}fontSize={["7px","10px","17px"]} borderRadius="xl"  id="resume-button-2" ><Link to="https://drive.google.com/file/d/1wOhjFp3m5wa1uqpqTEeIPV8iWZkaKb7h/view?usp=sharing"  id="resume-link-2" isExternal  onClick={(e)=>{
            downloadResume(e)
        }}>Resume</Link></Box>
        </Box>
